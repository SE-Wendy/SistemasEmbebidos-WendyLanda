...
digitalWrite ( ACTUADOR , HIGH ); // Apagar actuador
...
if( HUMEDAD > SetPoint )// Pregunta si lel valor de la variable HUMEDAD es mayor al valor de la variable Setpoint y en caso de ser cierto realiza las siguientes acciones
{
